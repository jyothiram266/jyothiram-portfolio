...
function Footer() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/jyothiram266/github-profile-finder")
  ...
  return (
    <footer>
      <Link
        href="https://github.com/jyothiram266/github-profile-finder"
        target="_blank"
        className="footer-link"
      >
        <span className="footer-info">Designed and Built by Jyothi Ram.</span>
        {githubInfo && (
